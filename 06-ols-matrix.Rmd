...
$$
Let's do like we did with bivariate regression, and imagine estimating the parameters of the model by least squares.  Let $(b_r, b_s, b_t)$ denote an estimate of the parameters.[^no-hats]  We will set up the sum of squared errors as a function of the parameters,
$$
\SSE(b_r, b_s, b_t)
