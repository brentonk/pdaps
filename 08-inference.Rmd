...
$$
which, despite all the matrices involved, works out to be a scalar.  Under $H_0$, the asymptotic sampling distribution of $W$ is $\chi^2_r$, the chi-squared distribution with $r$ degrees of freedom.[^wald-equivalence]
